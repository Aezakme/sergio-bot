...
def add_chat_handlers(dp):
    ...
    dp.add_handler(CommandHandler(CMDS['common']['putin']['name'], putin, filters=cmd_filter))
    dp.add_handler(
    ...
    # dp.add_handler(CommandHandler(CMDS['common']['putin'], putin, filters=cmd_filter))
    ...
    dp.add_handler(CommandHandler(CMDS['common']['iall']['name'], cmd_iall, filters=cmd_filter))
